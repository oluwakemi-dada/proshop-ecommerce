...
export enum ProductCreateReviewActionTypes {
  ...
  PRODUCT_CREATE_REVIEW_FAILURE_RESET = 'PRODUCT_CREATE_REVIEW_FAILURE_RESET',
...
export interface ProductCreateReviewFailureResetAction {
...
export type ProductCreateReviewAction =
  ...
  | ProductCreateReviewFailureResetAction
